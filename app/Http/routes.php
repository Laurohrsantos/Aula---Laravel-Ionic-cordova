...
Route::group(['prefix' => 'admin','middleware' => 'auth.checkrole:admin', 'as' => 'admin/'], function () {
    ...
    Route::get('categories/delet/{id}', ['as' => 'categories/delet', 'uses' => 'CategoriesController@delet']);
    ...
    Route::get('products/delet/{id}', ['as' => 'products/delet', 'uses' => 'ProductsController@delet']);
    ...
    Route::get('clients/delet/{id}', ['as' => 'clients/delet', 'uses' => 'ClientsController@delet']);
    ...
    Route::get('cupoms/delet/{id}', ['as' => 'cupoms/delet', 'uses' => 'CupomsController@delet']);
...
Route::group(['prefix' => 'api', 'middleware' => 'oauth', 'as' => 'api/'], function (){
    ...
    Route::get('teste', ['as' => 'teste/index', 'uses' => 'Api\Client\ClientCheckoutController@teste']);
